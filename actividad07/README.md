...
Crear un programa que imprima Hola y Adiós.
...
2. Abre `src/main/java/actividad07/Actividad07.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad07/Actividad07Test.java` con `Run As > JUnit Test`.
