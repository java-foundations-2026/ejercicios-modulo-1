...
2. Abre `src/main/java/actividad18/Actividad18.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad18/Actividad18Test.java` con `Run As > JUnit Test`.
