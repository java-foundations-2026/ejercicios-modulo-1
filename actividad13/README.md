...
Crear un programa que imprima Línea 1, Línea 2, Línea 3.
...
2. Abre `src/main/java/actividad13/Actividad13.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad13/Actividad13Test.java` con `Run As > JUnit Test`.
