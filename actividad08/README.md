...
Crear un programa que imprima Java Foundations Oracle.
...
2. Abre `src/main/java/actividad08/Actividad08.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad08/Actividad08Test.java` con `Run As > JUnit Test`.
