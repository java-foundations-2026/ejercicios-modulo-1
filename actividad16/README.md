...
Introducir comentarios de una línea.
...
2. Abre `src/main/java/actividad16/Actividad16.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad16/Actividad16Test.java` con `Run As > JUnit Test`.
