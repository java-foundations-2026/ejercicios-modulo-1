...
Crear String ciudad = "Madrid"; y mostrarla por pantalla.
...
2. Abre `src/main/java/actividad19/Actividad19.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad19/Actividad19Test.java` con `Run As > JUnit Test`.
