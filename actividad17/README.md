...
Explicar que una línea comentada no se ejecuta.
...
2. Abre `src/main/java/actividad17/Actividad17.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad17/Actividad17Test.java` con `Run As > JUnit Test`.
