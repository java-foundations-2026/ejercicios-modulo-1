...
2. Abre `src/main/java/actividad14/Actividad14.java`.
3. Corrige el código si es necesario.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/actividad14/Actividad14Test.java` con `Run As > JUnit Test`.
